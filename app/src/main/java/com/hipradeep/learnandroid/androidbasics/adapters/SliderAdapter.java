package com.hipradeep.learnandroid.androidbasics.adapters;
...
public class SliderAdapter extends SliderViewAdapter<SliderAdapter.SliderAdapterViewHolder> {
    ...
    public SliderAdapterViewHolder onCreateViewHolder(ViewGroup parent) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.sldr_item_layout, null);
...
//                .fitCenter()
//                .placeholder(R.drawable.undraw_1)
